...
public class ExceptionManagement {
    ...
    public ResponseEntity<CustomErrorResponse> authExceptionManagement(BookingException ex, HttpServletRequest request){
        Map<HttpStatus, String> status = new HashMap<>();
        status = switch(ex.message()){
            case ErrMsg.TOUR_NOT_BOOKABLE -> Map.of(HttpStatus.NOT_FOUND, "https://en.wikipedia.org/wiki/List_of_HTTP_status_codes#409");
            case ErrMsg.TOUR_ALREADY_BOOKED -> Map.of(HttpStatus.CONFLICT, "https://en.wikipedia.org/wiki/List_of_HTTP_status_codes#409");
