...
public enum TourStatus {
    ...
    SOLD_OUT, // il tour ha raggiunto il numero max di partecipanti ma non è ancora partito
    ...
    // *** I tour nei successivi tre stati non possono essere ripristinati
    CANCELED, // il tour stato cancellato per cause di forza maggiore (es. motivi geopolitici)
    CANCELED_DUE_AGENCY_INACTIVITY,  // tour cancellato per cessazione agenzia
    CANCELED_DUE_COUNTRY_INACTIVITY // tour cancellato per destinazione disattivata
}
