...
/**  The structure of CustomErrorResponse is compliant to  <a href="https://www.rfc-editor.org/rfc/rfc7807.html">rfc 7807</a> */
...
public class CustomErrorResponse {
    ...
    public static CustomErrorResponse getCustomErrorResponse(String type, HttpStatus httpStatus, String uri, String errorMsg){
        return new CustomErrorResponse( type, httpStatus.name(), httpStatus.value(), uri, Map.of("error", errorMsg), LocalDateTime.now() ); }
