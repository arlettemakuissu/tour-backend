...
public class AgencyService {
    ...
    public AgencyResponse save(AgencyRequest req){
        ...
        // verifico che non ci sia già un'agenzia con lo stesso vat
        String vat = req.getVat().trim();
        if(agencyRepository.existsByVat(vat))
            throw new Exception409("Un'agenzia con lo stesso vat esiste già a sistema");
