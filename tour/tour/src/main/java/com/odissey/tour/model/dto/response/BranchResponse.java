...
public class BranchResponse {
    ...
    public BranchResponse(Integer id, String name, String city, String vat, String countryName, String address) {
        this.id = id;
        this.name = name;
        this.city = city;
        this.vat = vat;
    ...
    public BranchResponse(Integer id, String name, String vat, String address, String city, Integer agencyId, String agencyName) {
        this.id = id;
        this.name = name;
        this.vat = vat;
        this.address = address;
